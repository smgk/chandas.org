...
| --- | --- | --- |
| Śara | `4+4` = 8 | `4+4+4+2` = 14 |
| Kusuma | `5+5` = 10 | `5+5+5+2` = 17 |
| Bhoga | `3+3+3+3` = 12 | `3+3+3+3+3+3+2` = 20 |
...
expert-approved exact.

## References

- Nāgavarma, *Canarese Prosody*, Ferdinand Kittel edition (1875), rules
  288–313: <https://archive.org/details/nagavarmascanare00nagarich>
